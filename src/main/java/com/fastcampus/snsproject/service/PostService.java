...
public class PostService {
    ...
    public Post modify(String title, String body, String userName, Integer postId) {
        ...
        return Post.fromEntitiy(postEntityRepository.saveAndFlush(postEntity));
    ...
    public Page<Post> list(Pageable pageable) {
        return postEntityRepository.findAll(pageable).map(Post::fromEntitiy);
    }

    public Page<Post> my(String userName, Pageable pageable) {
        UserEntity userEntity = getUserEntityOrException(userName);

        return postEntityRepository.findAllByUser(userEntity, pageable).map(Post::fromEntitiy);
    }
    ...
    public Page<Comment> getComments(Integer postId, Pageable pageable) {
        PostEntity postEntity = getPostEntityOrException(postId);
        return commentEntityRepository.findAllByPost(postEntity, pageable).map(Comment::fromEntitiy);
    }
