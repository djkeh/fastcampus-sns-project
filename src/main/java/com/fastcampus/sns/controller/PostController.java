...
import com.fastcampus.sns.configureration.AuthenticationConfig;
...
public class PostController {
    ...
    @PutMapping("/{postId}")
    public Response<PostResponse> modify(@RequestBody Integer postId, PostModifyRequest request, Authentication authentication) {
