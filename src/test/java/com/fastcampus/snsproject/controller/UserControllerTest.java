...
public class UserControllerTest {
    ...
    @Test
    public void 이미_존재하는_userName으로_회원가입하는_경우_에러반환() throws Exception {
        String userName = "userName";
        String password = "password";
    ...
    public void 로그인() throws Exception {
        ...
        when(userService.login(userName, password)).thenReturn("test_toekn");
    ...
    @Test
    @WithAnonymousUser
    void 알람리시트요청시_로그인하지_않은_경우() throws Exception {
        when(userService.alarmList(any(), any())).thenReturn(Page.empty());
