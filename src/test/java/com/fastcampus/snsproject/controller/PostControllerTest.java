...
public class PostControllerTest {
    ...
    @Test
    @WithAnonymousUser
    public void 포스트수정시_로그인_안한경우() throws Exception {
        String title = "title";
        String body = "body";
    ...
    @Test
    @WithMockUser
    public void 포스트수정시_본인이_작성한_글이_아니면_에러발생() throws Exception {
        String title = "title";
        String body = "body";
    ...
    @Test
    @WithMockUser
    public void 포스트수정시_수정하려는_글이_없을떄() throws Exception {
        String title = "title";
        String body = "body";
    ...
    public void 포스트삭제() throws Exception {
        ...
        mockMvc.perform(delete("/api/v1/posts/1")
                ...
                .andExpect(status().isOk());//Error
    }

    @Test
    @WithAnonymousUser
    public void 포스트삭제시_로그인_하지_않은경우() throws Exception {
    ...
    @Test
    @WithMockUser
    public void 포스트삭제시_작성한_유저가_아닌경우() throws Exception {
    ...
    @Test
    @WithMockUser
    public void 포스트삭제시_포스트가_존재하지_않는_경우() throws Exception {
        ...
        mockMvc.perform(delete("/api/v1/posts/1")
                ...
                .andDo(print())
                .andExpect(status().isNotFound());//Error
    }
    ...
    @Test
    @WithAnonymousUser
    public void 피드목록요청시_로그인_하지_않은경우() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    public void 내피드목록요청시_로그인_하지_않은경우() throws Exception {
    ...
    @Test
    @WithMockUser
    void 댓글작성_게시물이_없는경우() throws Exception{
