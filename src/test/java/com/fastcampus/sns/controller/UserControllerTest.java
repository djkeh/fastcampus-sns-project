...
public class UserControllerTest {
    ...
    @Test
    public void 이미회원가입된username으로회원가입시에러반환() throws Exception {
        String userName = "userName";
        String password = "password";
    ...
    public void 로그인() throws Exception {
        ...
        when(userService.login(userName,password)).thenReturn("test_tocken");
    ...
    @Test
    public void 로그인시회원가입안된userName입력할경우에러반환() throws Exception {
        String userName = "userName";
        String password = "password";
    ...
    @Test
    public void 로그인시틀린password입력할경우에러반환() throws Exception {
        String userName = "userName";
        String password = "password";
